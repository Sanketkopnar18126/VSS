...
//   const message = `Hello My name is ${profile.userName} & an  ${
//     profile.company
//   }  ${profile.location} Employee,
//   i'm from Bhopal. I got a job offer from ${profile.company} ${
//     profile.location
//   }, though i belong to ${profile.city.toLowerCase()} still ${
//     profile.company
//   } offered me`;
